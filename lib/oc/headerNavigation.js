...
function headernavigation() {
    ...
    function template() {
        return [
            ...
            '<li ng-show="user.Type!=\'TempCustomer\'" class="dropdown">',
            '<span style="cursor: pointer;" class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Orders <span class="caret"></span> </span>',
            ...
            '<li><a href="cart">Cart&nbsp;',
            '<span ng-show="cartCount" ng-bind="cartCount" class="badge"></span>',
            '</a></li>',
            '<li>&nbsp;|&nbsp;</li>',
